...

{
...

    {
...

        {
            ...
            server = new TcpListener(IPAddress.Any, 11000); // 서버 접속 IP, 포트
...

            {
...

                {
                    ...
                    SendMessageAll(user_name + "#Join", "", false); // 모든 client에게 메세지 전송
...

        {
...

            {
                ...
                date = DateTime.Now.ToString("HH:mm:ss"); // 현재 날짜 받기
        ...
        {
            SendMessageAll(textBox2.Text, "", false);
        }
